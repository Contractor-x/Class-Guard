 ...
 * @export
 */
export declare const ElementsConfigsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listElementsConfigs: (projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ElementsConfigsApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new elements_config under the active organization.
     * @summary Create Elements Config
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createElementsConfig(projId: string, envId: string, elementsConfigCreate: ElementsConfigCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsConfigRead>>;
    /**
     * Deletes the elements_config and all its related data.
     * @summary Delete Elements Config
     * @param {string} elementsConfigId Either the unique id of the elements_config, or the URL-friendly key of the elements_config (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteElementsConfig(elementsConfigId: string, projId: string, envId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single elements_config matching the given elements_config_id, if such elements_config exists.
     * @summary Get Elements Config
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getElementsConfig(projId: string, envId: string, elementsConfigId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsConfigRead>>;
    /**
     * Gets a single elements_config matching the given elements_config_id, if such elements_config exists.
     * @summary Get Elements Config Runtime
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getElementsConfigRuntime(projId: string, envId: string, elementsConfigId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsConfigRuntimeRead>>;
    /**
     *
     * @summary Get Elements Type Config
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getElementsTypeConfig(projId: string, envId: string, elementType: ElementsType, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsEnvTypeRead>>;
    /**
     * Lists all the elements_configs under the active organization.
     * @summary List Elements Configs
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listElementsConfigs(projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaginatedResultElementsConfigRead>>;
    /**
     * Updates the elements_config.
     * @summary Update Elements Config
     * @param {string} elementsConfigId Either the unique id of the elements_config, or the URL-friendly key of the elements_config (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateElementsConfig(elementsConfigId: string, projId: string, envId: string, elementsConfigUpdate: ElementsConfigUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsConfigRead>>;
    /**
     *
     * @summary Update Elements Type Permissions
     * @param {ElementsType} elementType Either the unique id of the elements_type, or the URL-friendly key of the elements_type (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateElementsTypePermissions(elementType: ElementsType, projId: string, envId: string, elementsEnvTypeUpdate: ElementsEnvTypeUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ElementsEnvTypeRead>>;
};
/**
 * ElementsConfigsApi - factory interface
 * @export
 */
export declare const ElementsConfigsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new elements_config under the active organization.
     * @summary Create Elements Config
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listElementsConfigs(projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<PaginatedResultElementsConfigRead>;
    /**
     * Updates the elements_config.
     * @summary Update Elements Config
     * @param {string} elementsConfigId Either the unique id of the elements_config, or the URL-friendly key of the elements_config (i.e: the \&quot;slug\&quot;).
...
export declare class ElementsConfigsApi extends BaseAPI {
     ...
     */
    createElementsConfig(requestParameters: ElementsConfigsApiCreateElementsConfigRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsConfigRead>>;
    /**
     * Deletes the elements_config and all its related data.
     * @summary Delete Elements Config
     ...
     * @memberof ElementsConfigsApi
     */
    deleteElementsConfig(requestParameters: ElementsConfigsApiDeleteElementsConfigRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single elements_config matching the given elements_config_id, if such elements_config exists.
     * @summary Get Elements Config
     ...
     * @memberof ElementsConfigsApi
     */
    getElementsConfig(requestParameters: ElementsConfigsApiGetElementsConfigRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsConfigRead>>;
    /**
     * Gets a single elements_config matching the given elements_config_id, if such elements_config exists.
     * @summary Get Elements Config Runtime
     ...
     * @memberof ElementsConfigsApi
     */
    getElementsConfigRuntime(requestParameters: ElementsConfigsApiGetElementsConfigRuntimeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsConfigRuntimeRead>>;
    /**
     *
     * @summary Get Elements Type Config
     ...
     * @memberof ElementsConfigsApi
     */
    getElementsTypeConfig(requestParameters: ElementsConfigsApiGetElementsTypeConfigRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsEnvTypeRead>>;
    /**
     * Lists all the elements_configs under the active organization.
     * @summary List Elements Configs
     ...
     * @memberof ElementsConfigsApi
     */
    listElementsConfigs(requestParameters: ElementsConfigsApiListElementsConfigsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PaginatedResultElementsConfigRead>>;
    /**
     * Updates the elements_config.
     * @summary Update Elements Config
     ...
     * @memberof ElementsConfigsApi
     */
    updateElementsConfig(requestParameters: ElementsConfigsApiUpdateElementsConfigRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsConfigRead>>;
    /**
     *
     * @summary Update Elements Type Permissions
     ...
     * @memberof ElementsConfigsApi
     */
    updateElementsTypePermissions(requestParameters: ElementsConfigsApiUpdateElementsTypePermissionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ElementsEnvTypeRead>>;
}
