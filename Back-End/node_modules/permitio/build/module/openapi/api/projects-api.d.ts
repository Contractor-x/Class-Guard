...
export declare const ProjectsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    listProjects: (page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Updates the project.
...
export declare const ProjectsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    createProject(projectCreate: ProjectCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ProjectRead>>;
    /**
     * Deletes the project and all its related data.
     * @summary Delete Project
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteProject(projId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single project matching the given proj_id, if such project exists.
     * @summary Get Project
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getProject(projId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ProjectRead>>;
    /**
     * Lists all the projects under the active organization.
     * @summary List Projects
     * @param {number} [page] Page number of the results to fetch, starting at 1.
     ...
     * @throws {RequiredError}
     */
    listProjects(page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ProjectRead>>>;
    /**
     * Updates the project.
     * @summary Update Project
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateProject(projId: string, projectUpdate: ProjectUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ProjectRead>>;
};
/**
...
export declare const ProjectsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    listProjects(page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ProjectRead>>;
    /**
     * Updates the project.
     * @summary Update Project
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ProjectsApi extends BaseAPI {
     ...
     */
    createProject(requestParameters: ProjectsApiCreateProjectRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead>>;
    /**
     * Deletes the project and all its related data.
     * @summary Delete Project
     ...
     * @memberof ProjectsApi
     */
    deleteProject(requestParameters: ProjectsApiDeleteProjectRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single project matching the given proj_id, if such project exists.
     * @summary Get Project
     ...
     * @memberof ProjectsApi
     */
    getProject(requestParameters: ProjectsApiGetProjectRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead>>;
    /**
     * Lists all the projects under the active organization.
     * @summary List Projects
     ...
     * @memberof ProjectsApi
     */
    listProjects(requestParameters?: ProjectsApiListProjectsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead[]>>;
    /**
     * Updates the project.
     * @summary Update Project
     ...
     * @memberof ProjectsApi
     */
    updateProject(requestParameters: ProjectsApiUpdateProjectRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead>>;
}
