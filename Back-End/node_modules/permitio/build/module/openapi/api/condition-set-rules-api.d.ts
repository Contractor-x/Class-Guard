 ...
 * @export
 */
export declare const ConditionSetRulesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listSetPermissions: (projId: string, envId: string, userSet?: string | undefined, permission?: string | undefined, resourceSet?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ConditionSetRulesApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Grant permissions to a user set *on* a resource set.  If the permission is already granted, it is skipped.
     * @summary Assign Set Permissions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    assignSetPermissions(projId: string, envId: string, conditionSetRuleCreate: ConditionSetRuleCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ConditionSetRuleRead>>>;
    /**
     * Lists the condition set rules matching the filter. - If the `user_set` filter is present, will only return the permissions set of that user set. - If the `permission` filter is present, will only return the permissions sets that equals to the queried permission. - If the `resource_set` filter is present, will only return the permissions set of that resource set.
     * @summary List Set Permissions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    unassignSetPermissions(projId: string, envId: string, conditionSetRuleRemove: ConditionSetRuleRemove, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
};
/**
 * ConditionSetRulesApi - factory interface
 * @export
 */
export declare const ConditionSetRulesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Grant permissions to a user set *on* a resource set.  If the permission is already granted, it is skipped.
     * @summary Assign Set Permissions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listSetPermissions(projId: string, envId: string, userSet?: string | undefined, permission?: string | undefined, resourceSet?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ConditionSetRuleRead>>;
    /**
     * Revokes permissions to a user set *on* a resource set.  If the permission is not granted, it is skipped.
     * @summary Unassign Set Permissions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ConditionSetRulesApi extends BaseAPI {
     ...
     */
    assignSetPermissions(requestParameters: ConditionSetRulesApiAssignSetPermissionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ConditionSetRuleRead[]>>;
    /**
     * Lists the condition set rules matching the filter. - If the `user_set` filter is present, will only return the permissions set of that user set. - If the `permission` filter is present, will only return the permissions sets that equals to the queried permission. - If the `resource_set` filter is present, will only return the permissions set of that resource set.
     * @summary List Set Permissions
     ...
     * @memberof ConditionSetRulesApi
     */
    listSetPermissions(requestParameters: ConditionSetRulesApiListSetPermissionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ConditionSetRuleRead[]>>;
    /**
     * Revokes permissions to a user set *on* a resource set.  If the permission is not granted, it is skipped.
     * @summary Unassign Set Permissions
     ...
     * @memberof ConditionSetRulesApi
     */
    unassignSetPermissions(requestParameters: ConditionSetRulesApiUnassignSetPermissionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
}
