 ...
 * @export
 */
export declare const ResourceActionsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listResourceActions: (projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ResourceActionsApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new action that can affect the resource.
     * @summary Create Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createResourceAction(projId: string, envId: string, resourceId: string, resourceActionCreate: ResourceActionCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceActionRead>>;
    /**
     * Deletes the action and all its related data. This includes any permissions granted to perform the action.
     * @summary Delete Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteResourceAction(projId: string, envId: string, resourceId: string, actionId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single action defined on the resource, if such action exists.
     * @summary Get Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getResourceAction(projId: string, envId: string, resourceId: string, actionId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceActionRead>>;
    /**
     * Lists all the actions defined on the resource.
     * @summary List Resource Actions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceActions(projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ResourceActionRead>>>;
    /**
     * Partially updates the action defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateResourceAction(projId: string, envId: string, resourceId: string, actionId: string, resourceActionUpdate: ResourceActionUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceActionRead>>;
};
/**
 * ResourceActionsApi - factory interface
 * @export
 */
export declare const ResourceActionsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new action that can affect the resource.
     * @summary Create Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceActions(projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ResourceActionRead>>;
    /**
     * Partially updates the action defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Action
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ResourceActionsApi extends BaseAPI {
     ...
     */
    createResourceAction(requestParameters: ResourceActionsApiCreateResourceActionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceActionRead>>;
    /**
     * Deletes the action and all its related data. This includes any permissions granted to perform the action.
     * @summary Delete Resource Action
     ...
     * @memberof ResourceActionsApi
     */
    deleteResourceAction(requestParameters: ResourceActionsApiDeleteResourceActionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single action defined on the resource, if such action exists.
     * @summary Get Resource Action
     ...
     * @memberof ResourceActionsApi
     */
    getResourceAction(requestParameters: ResourceActionsApiGetResourceActionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceActionRead>>;
    /**
     * Lists all the actions defined on the resource.
     * @summary List Resource Actions
     ...
     * @memberof ResourceActionsApi
     */
    listResourceActions(requestParameters: ResourceActionsApiListResourceActionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceActionRead[]>>;
    /**
     * Partially updates the action defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Action
     ...
     * @memberof ResourceActionsApi
     */
    updateResourceAction(requestParameters: ResourceActionsApiUpdateResourceActionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceActionRead>>;
}
