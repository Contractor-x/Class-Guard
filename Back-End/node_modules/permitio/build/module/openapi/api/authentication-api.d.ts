...
export declare const AuthenticationApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    login: (inviteCode?: string | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
...
export declare const AuthenticationApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    devLogin(devLogin: DevLogin, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     *
     * @summary Elements Login As
     * @param {UserLoginRequestInput} userLoginRequestInput
     ...
     * @throws {RequiredError}
     */
    elementsLoginAs(userLoginRequestInput: UserLoginRequestInput, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<EmbeddedLoginRequestOutput>>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
     * @summary Login
     * @param {string} [inviteCode] An optional invite code to an existing organization. If the invite code is provided and is valid, the member will gain access to that organization.
     ...
     * @throws {RequiredError}
     */
    login(inviteCode?: string | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<LoginResult>>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
     * @summary Login Elements
     * @param {string} token
     ...
     * @throws {RequiredError}
     */
    loginElements(token: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<LoginResult>>;
    /**
     * The logout endpoint deletes the session cookie of a logged in user and invalidates cached VCs.
     * @summary Logout Get
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    logoutGet(options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * The logout endpoint deletes the session cookie of a logged in user and invalidates cached VCs.
     * @summary Logout Post
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    logoutPost(options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     *
     * @summary Me
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    me(options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AuthnMeRead>>;
    /**
     * Allows the user to switch his active organization (manipulates the user\'s login session).  This route will return a new login cookie to the user.
     * @summary Switch Organization
     * @param {string} orgId the organization id the user wishes to switch to as the active org on the session
     ...
     * @throws {RequiredError}
     */
    switchOrganization(orgId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<LoginResult>>;
};
/**
...
export declare const AuthenticationApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    login(inviteCode?: string | undefined, options?: any): AxiosPromise<LoginResult>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
     * @summary Login Elements
     * @param {string} token
...
export declare class AuthenticationApi extends BaseAPI {
     ...
     */
    devLogin(requestParameters: AuthenticationApiDevLoginRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     *
     * @summary Elements Login As
     ...
     * @memberof AuthenticationApi
     */
    elementsLoginAs(requestParameters: AuthenticationApiElementsLoginAsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<EmbeddedLoginRequestOutput>>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
     * @summary Login
     ...
     * @memberof AuthenticationApi
     */
    login(requestParameters?: AuthenticationApiLoginRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<LoginResult>>;
    /**
     * The login endpoint allows the frontend app to exchange a user JWT with a user session. The user session is stored on an httpOnly + secure cookie.
     * @summary Login Elements
     ...
     * @memberof AuthenticationApi
     */
    loginElements(requestParameters: AuthenticationApiLoginElementsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<LoginResult>>;
    /**
     * The logout endpoint deletes the session cookie of a logged in user and invalidates cached VCs.
     * @summary Logout Get
     * @param {*} [options] Override http request option.
     ...
     * @memberof AuthenticationApi
     */
    logoutGet(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * The logout endpoint deletes the session cookie of a logged in user and invalidates cached VCs.
     * @summary Logout Post
     * @param {*} [options] Override http request option.
     ...
     * @memberof AuthenticationApi
     */
    logoutPost(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     *
     * @summary Me
     * @param {*} [options] Override http request option.
     ...
     * @memberof AuthenticationApi
     */
    me(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AuthnMeRead>>;
    /**
     * Allows the user to switch his active organization (manipulates the user\'s login session).  This route will return a new login cookie to the user.
     * @summary Switch Organization
     ...
     * @memberof AuthenticationApi
     */
    switchOrganization(requestParameters: AuthenticationApiSwitchOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<LoginResult>>;
}
