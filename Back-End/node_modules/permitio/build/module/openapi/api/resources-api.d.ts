 ...
 * @export
 */
export declare const ResourcesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listResources: (projId: string, envId: string, includeBuiltIn?: boolean | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ResourcesApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new resource (a type of object you may protect with permissions).
     * @summary Create Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createResource(projId: string, envId: string, resourceCreate: ResourceCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceRead>>;
    /**
     * Deletes the resource and all its related data.
     * @summary Delete Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteResource(projId: string, envId: string, resourceId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single resource, if such resource exists.
     * @summary Get Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getResource(projId: string, envId: string, resourceId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceRead>>;
    /**
     * Lists all the resources defined in your schema.
     * @summary List Resources
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResources(projId: string, envId: string, includeBuiltIn?: boolean | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ResourceRead>>>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    replaceResource(projId: string, envId: string, resourceId: string, resourceReplace: ResourceReplace, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceRead>>;
    /**
     * Partially updates the resource definition. Fields that will be provided will be completely overwritten.
     * @summary Update Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateResource(projId: string, envId: string, resourceId: string, resourceUpdate: ResourceUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceRead>>;
};
/**
 * ResourcesApi - factory interface
 * @export
 */
export declare const ResourcesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new resource (a type of object you may protect with permissions).
     * @summary Create Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResources(projId: string, envId: string, includeBuiltIn?: boolean | undefined, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ResourceRead>>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ResourcesApi extends BaseAPI {
     ...
     */
    createResource(requestParameters: ResourcesApiCreateResourceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceRead>>;
    /**
     * Deletes the resource and all its related data.
     * @summary Delete Resource
     ...
     * @memberof ResourcesApi
     */
    deleteResource(requestParameters: ResourcesApiDeleteResourceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single resource, if such resource exists.
     * @summary Get Resource
     ...
     * @memberof ResourcesApi
     */
    getResource(requestParameters: ResourcesApiGetResourceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceRead>>;
    /**
     * Lists all the resources defined in your schema.
     * @summary List Resources
     ...
     * @memberof ResourcesApi
     */
    listResources(requestParameters: ResourcesApiListResourcesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceRead[]>>;
    /**
     * Completely replaces the resource definition.  - If the resource key is changed, all role and permissions assignments for the the resource will be revoked. - If the resource key is unchanged, but some actions are removed or renamed from the resource definition, role and permissions assignments for these actions will be revoked.  TODO: we need to decide if we are auto-revoking, or if we are rejecting the PUT completely while there are permissions that can be affected.
     * @summary Replace Resource
     ...
     * @memberof ResourcesApi
     */
    replaceResource(requestParameters: ResourcesApiReplaceResourceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceRead>>;
    /**
     * Partially updates the resource definition. Fields that will be provided will be completely overwritten.
     * @summary Update Resource
     ...
     * @memberof ResourcesApi
     */
    updateResource(requestParameters: ResourcesApiUpdateResourceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceRead>>;
}
