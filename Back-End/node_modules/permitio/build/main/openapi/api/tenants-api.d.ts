 ...
 * @export
 */
export declare const TenantsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listTenantUsers: (projId: string, tenantId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listTenants: (projId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const TenantsApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new tenant inside the Permit.io system.  If the tenant is already created: will return 200 instead of 201, and will return the existing tenant object in the response body.
     * @summary Create Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createTenant(projId: string, envId: string, tenantCreate: TenantCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TenantRead>>;
    /**
     * Deletes the tenant and all its related data.
     * @summary Delete Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteTenant(projId: string, envId: string, tenantId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Deletes a user under a tenant.
     * @summary Delete Tenant User
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteTenantUser(projId: string, envId: string, tenantId: string, userId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a tenant, if such tenant exists. Otherwise returns 404.
     * @summary Get Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getTenant(projId: string, envId: string, tenantId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TenantRead>>;
    /**
     *
     * @summary List Tenant Users
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listTenantUsers(projId: string, tenantId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PaginatedResultUserRead>>;
    /**
     * Lists all the tenants defined within an environment.
     * @summary List Tenants
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listTenants(projId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<TenantRead>>>;
    /**
     * Partially updates the tenant definition. Fields that will be provided will be completely overwritten.
     * @summary Update Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateTenant(projId: string, envId: string, tenantId: string, tenantUpdate: TenantUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TenantRead>>;
};
/**
 * TenantsApi - factory interface
 * @export
 */
export declare const TenantsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new tenant inside the Permit.io system.  If the tenant is already created: will return 200 instead of 201, and will return the existing tenant object in the response body.
     * @summary Create Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listTenantUsers(projId: string, tenantId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<PaginatedResultUserRead>;
    /**
     * Lists all the tenants defined within an environment.
     * @summary List Tenants
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listTenants(projId: string, envId: string, search?: string | undefined, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<TenantRead>>;
    /**
     * Partially updates the tenant definition. Fields that will be provided will be completely overwritten.
     * @summary Update Tenant
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class TenantsApi extends BaseAPI {
     ...
     * @memberof TenantsApi
     */
    createTenant(requestParameters: TenantsApiCreateTenantRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TenantRead>>;
    /**
     * Deletes the tenant and all its related data.
     * @summary Delete Tenant
     ...
     * @memberof TenantsApi
     */
    deleteTenant(requestParameters: TenantsApiDeleteTenantRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Deletes a user under a tenant.
     * @summary Delete Tenant User
     ...
     * @memberof TenantsApi
     */
    deleteTenantUser(requestParameters: TenantsApiDeleteTenantUserRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a tenant, if such tenant exists. Otherwise returns 404.
     * @summary Get Tenant
     ...
     * @memberof TenantsApi
     */
    getTenant(requestParameters: TenantsApiGetTenantRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TenantRead>>;
    /**
     *
     * @summary List Tenant Users
     ...
     * @memberof TenantsApi
     */
    listTenantUsers(requestParameters: TenantsApiListTenantUsersRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PaginatedResultUserRead>>;
    /**
     * Lists all the tenants defined within an environment.
     * @summary List Tenants
     ...
     * @memberof TenantsApi
     */
    listTenants(requestParameters: TenantsApiListTenantsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TenantRead[]>>;
    /**
     * Partially updates the tenant definition. Fields that will be provided will be completely overwritten.
     * @summary Update Tenant
     ...
     * @memberof TenantsApi
     */
    updateTenant(requestParameters: TenantsApiUpdateTenantRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TenantRead>>;
}
