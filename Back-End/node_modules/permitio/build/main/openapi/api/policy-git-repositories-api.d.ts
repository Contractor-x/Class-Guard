 ...
 * @export
 */
export declare const PolicyGitRepositoriesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listPolicyRepos: (projId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * PolicyGitRepositoriesApi - functional programming interface
 * @export
 */
export declare const PolicyGitRepositoriesApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Disable the currently active policy repo, this action means to turn off the gitops feature. If there is no active policy repo, this action will do nothing.
     * @summary Activate Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    activatePolicyRepo(projId: string, repoId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ProjectRead>>;
    /**
     * Creates a new policy repository configuration under a given project. The given repository is created with status \'pending\', it will be changed and used as the \'active\' repository for the policy only after a successful attempt to use it. The repository main branch must be present in the remote.
     * @summary Create Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createPolicyRepo(projId: string, policyRepoCreate: PolicyRepoCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PolicyRepoRead>>;
    /**
     * Deletes an environment and all its related data.
     * @summary Delete Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deletePolicyRepo(projId: string, repoId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Disable the currently active policy repo, this action means to turn off the gitops feature. If there is no active policy repo, this action will do nothing.
     * @summary Disable Active Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    disableActivePolicyRepo(projId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ProjectRead>>;
    /**
     * Gets the currently active repository, if such repository exists.
     * @summary Get Active Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getActivePolicyRepo(projId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PolicyRepoRead>>;
    /**
     * Gets a single repository matching the given repo_id, if such repository exists.
     * @summary Get Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getPolicyRepo(projId: string, repoId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<PolicyRepoRead>>;
    /**
     * Lists all the policy repositories under a given project.
     * @summary List Policy Repos
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listPolicyRepos(projId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<PolicyRepoRead>>>;
};
/**
 * PolicyGitRepositoriesApi - factory interface
 * @export
 */
export declare const PolicyGitRepositoriesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Disable the currently active policy repo, this action means to turn off the gitops feature. If there is no active policy repo, this action will do nothing.
     * @summary Activate Policy Repo
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listPolicyRepos(projId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<PolicyRepoRead>>;
};
/**
...
export declare class PolicyGitRepositoriesApi extends BaseAPI {
     ...
     */
    activatePolicyRepo(requestParameters: PolicyGitRepositoriesApiActivatePolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead>>;
    /**
     * Creates a new policy repository configuration under a given project. The given repository is created with status \'pending\', it will be changed and used as the \'active\' repository for the policy only after a successful attempt to use it. The repository main branch must be present in the remote.
     * @summary Create Policy Repo
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    createPolicyRepo(requestParameters: PolicyGitRepositoriesApiCreatePolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PolicyRepoRead>>;
    /**
     * Deletes an environment and all its related data.
     * @summary Delete Policy Repo
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    deletePolicyRepo(requestParameters: PolicyGitRepositoriesApiDeletePolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Disable the currently active policy repo, this action means to turn off the gitops feature. If there is no active policy repo, this action will do nothing.
     * @summary Disable Active Policy Repo
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    disableActivePolicyRepo(requestParameters: PolicyGitRepositoriesApiDisableActivePolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProjectRead>>;
    /**
     * Gets the currently active repository, if such repository exists.
     * @summary Get Active Policy Repo
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    getActivePolicyRepo(requestParameters: PolicyGitRepositoriesApiGetActivePolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PolicyRepoRead>>;
    /**
     * Gets a single repository matching the given repo_id, if such repository exists.
     * @summary Get Policy Repo
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    getPolicyRepo(requestParameters: PolicyGitRepositoriesApiGetPolicyRepoRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PolicyRepoRead>>;
    /**
     * Lists all the policy repositories under a given project.
     * @summary List Policy Repos
     ...
     * @memberof PolicyGitRepositoriesApi
     */
    listPolicyRepos(requestParameters: PolicyGitRepositoriesApiListPolicyReposRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PolicyRepoRead[]>>;
}
