...
export declare const OrganizationsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    inviteMembersToOrganization: (orgId: string, inviteCreate: Array<InviteCreate>, inviterName?: string | undefined, inviterEmail?: string | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listOrganizationInvites: (orgId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listOrganizations: (page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const OrganizationsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    cancelInvite(orgId: string, inviteId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Creates a new organization that will be owned by the authenticated actor (i.e: human team member or api key).
     * @summary Create Organization
     * @param {OrganizationCreate} organizationCreate
     ...
     * @throws {RequiredError}
     */
    createOrganization(organizationCreate: OrganizationCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<OrganizationReadWithAPIKey>>;
    /**
     * Deletes an organization (Permit.io account) and all its related data.
     * @summary Delete Organization
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteOrganization(orgId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single organization (Permit.io account) matching the given org_id, if such org exists and can be accessed by the authenticated actor.
     * @summary Get Active Organization
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getActiveOrganization(options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<OrganizationRead>>;
    /**
     * Gets a single organization (Permit.io account) matching the given org_id, if such org exists and can be accessed by the authenticated actor.
     * @summary Get Organization
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getOrganization(orgId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<OrganizationRead>>;
    /**
     * Invite new members into the organization.
     * @summary Invite Members To Organization
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    inviteMembersToOrganization(orgId: string, inviteCreate: Array<InviteCreate>, inviterName?: string | undefined, inviterEmail?: string | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<MultiInviteResult>>;
    /**
     * Lists pending organization invites
     * @summary List Organization Invites
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listOrganizationInvites(orgId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<InviteRead>>>;
    /**
     * Lists all the organizations that can be accessed by the authenticated actor (i.e: human team member or api key).
     * @summary List Organizations
     * @param {number} [page] Page number of the results to fetch, starting at 1.
     ...
     * @throws {RequiredError}
     */
    listOrganizations(page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<OrganizationRead>>>;
    /**
     * Updates the organization\'s profile.
     * @summary Update Organization
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateOrganization(orgId: string, organizationUpdate: OrganizationUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<OrganizationRead>>;
};
/**
...
export declare const OrganizationsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    inviteMembersToOrganization(orgId: string, inviteCreate: Array<InviteCreate>, inviterName?: string | undefined, inviterEmail?: string | undefined, options?: any): AxiosPromise<MultiInviteResult>;
    /**
     * Lists pending organization invites
     * @summary List Organization Invites
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listOrganizationInvites(orgId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<InviteRead>>;
    /**
     * Lists all the organizations that can be accessed by the authenticated actor (i.e: human team member or api key).
     * @summary List Organizations
     * @param {number} [page] Page number of the results to fetch, starting at 1.
     ...
     * @throws {RequiredError}
     */
    listOrganizations(page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<OrganizationRead>>;
    /**
     * Updates the organization\'s profile.
     * @summary Update Organization
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
...
export declare class OrganizationsApi extends BaseAPI {
     ...
     */
    cancelInvite(requestParameters: OrganizationsApiCancelInviteRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Creates a new organization that will be owned by the authenticated actor (i.e: human team member or api key).
     * @summary Create Organization
     ...
     * @memberof OrganizationsApi
     */
    createOrganization(requestParameters: OrganizationsApiCreateOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OrganizationReadWithAPIKey>>;
    /**
     * Deletes an organization (Permit.io account) and all its related data.
     * @summary Delete Organization
     ...
     * @memberof OrganizationsApi
     */
    deleteOrganization(requestParameters: OrganizationsApiDeleteOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single organization (Permit.io account) matching the given org_id, if such org exists and can be accessed by the authenticated actor.
     * @summary Get Active Organization
     * @param {*} [options] Override http request option.
     ...
     * @memberof OrganizationsApi
     */
    getActiveOrganization(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OrganizationRead>>;
    /**
     * Gets a single organization (Permit.io account) matching the given org_id, if such org exists and can be accessed by the authenticated actor.
     * @summary Get Organization
     ...
     * @memberof OrganizationsApi
     */
    getOrganization(requestParameters: OrganizationsApiGetOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OrganizationRead>>;
    /**
     * Invite new members into the organization.
     * @summary Invite Members To Organization
     ...
     * @memberof OrganizationsApi
     */
    inviteMembersToOrganization(requestParameters: OrganizationsApiInviteMembersToOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<MultiInviteResult>>;
    /**
     * Lists pending organization invites
     * @summary List Organization Invites
     ...
     * @memberof OrganizationsApi
     */
    listOrganizationInvites(requestParameters: OrganizationsApiListOrganizationInvitesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<InviteRead[]>>;
    /**
     * Lists all the organizations that can be accessed by the authenticated actor (i.e: human team member or api key).
     * @summary List Organizations
     ...
     * @memberof OrganizationsApi
     */
    listOrganizations(requestParameters?: OrganizationsApiListOrganizationsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OrganizationRead[]>>;
    /**
     * Updates the organization\'s profile.
     * @summary Update Organization
     ...
     * @memberof OrganizationsApi
     */
    updateOrganization(requestParameters: OrganizationsApiUpdateOrganizationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OrganizationRead>>;
}
