 ...
 * @export
 */
export declare const ResourceInstancesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    listResourceInstances: (projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ResourceInstancesApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new instance inside the Permit.io system.  If the instance is already created: will return 200 instead of 201, and will return the existing instance object in the response body.
     * @summary Create Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createResourceInstance(projId: string, envId: string, resourceInstanceCreate: ResourceInstanceCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceInstanceRead>>;
    /**
     * Deletes the instance and all its related data.
     * @summary Delete Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteResourceInstance(projId: string, envId: string, instanceId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a instance, if such instance exists. Otherwise returns 404.
     * @summary Get Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getResourceInstance(projId: string, envId: string, instanceId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceInstanceRead>>;
    /**
     * Lists all the resource instances defined within an environment.
     * @summary List Resource Instances
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceInstances(projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ResourceInstanceRead>>>;
    /**
     * Partially updates the instance definition. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateResourceInstance(projId: string, envId: string, instanceId: string, resourceInstanceUpdate: ResourceInstanceUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceInstanceRead>>;
};
/**
 * ResourceInstancesApi - factory interface
 * @export
 */
export declare const ResourceInstancesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new instance inside the Permit.io system.  If the instance is already created: will return 200 instead of 201, and will return the existing instance object in the response body.
     * @summary Create Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceInstances(projId: string, envId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ResourceInstanceRead>>;
    /**
     * Partially updates the instance definition. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Instance
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ResourceInstancesApi extends BaseAPI {
     ...
     */
    createResourceInstance(requestParameters: ResourceInstancesApiCreateResourceInstanceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceInstanceRead>>;
    /**
     * Deletes the instance and all its related data.
     * @summary Delete Resource Instance
     ...
     * @memberof ResourceInstancesApi
     */
    deleteResourceInstance(requestParameters: ResourceInstancesApiDeleteResourceInstanceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a instance, if such instance exists. Otherwise returns 404.
     * @summary Get Resource Instance
     ...
     * @memberof ResourceInstancesApi
     */
    getResourceInstance(requestParameters: ResourceInstancesApiGetResourceInstanceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceInstanceRead>>;
    /**
     * Lists all the resource instances defined within an environment.
     * @summary List Resource Instances
     ...
     * @memberof ResourceInstancesApi
     */
    listResourceInstances(requestParameters: ResourceInstancesApiListResourceInstancesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceInstanceRead[]>>;
    /**
     * Partially updates the instance definition. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Instance
     ...
     * @memberof ResourceInstancesApi
     */
    updateResourceInstance(requestParameters: ResourceInstancesApiUpdateResourceInstanceRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceInstanceRead>>;
}
