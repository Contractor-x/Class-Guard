 ...
 * @export
 */
export declare const OPALDataApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     *
     ...
     */
    getAllData: (orgId: string, projId: string, envId: string, internalUpdateCache?: boolean | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
 ...
 * @export
 */
export declare const OPALDataApiFp: (configuration?: Configuration | undefined) => {
    /**
     *
     * @summary Get All Data
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getAllData(orgId: string, projId: string, envId: string, internalUpdateCache?: boolean | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<FullData>>;
    /**
     *
     * @summary Get Data For Role
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getDataForRole(orgId: string, projId: string, envId: string, roleId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<RoleData>>;
    /**
     * return permission assignment data between user sets and resource sets (i.e: condition set rules data)
     * @summary Get Data For Set Rule
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getDataForSetRule(orgId: string, projId: string, envId: string, userSetId: string, resourceSetId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<{
        [key: string]: string[];
    }>>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getDataForUser(orgId: string, projId: string, envId: string, userId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<UserData>>;
};
/**
 * OPALDataApi - factory interface
 * @export
 */
export declare const OPALDataApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     *
     * @summary Get All Data
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getAllData(orgId: string, projId: string, envId: string, internalUpdateCache?: boolean | undefined, options?: any): AxiosPromise<FullData>;
    /**
     *
     * @summary Get Data For Role
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getDataForRole(orgId: string, projId: string, envId: string, roleId: string, options?: any): AxiosPromise<RoleData>;
    /**
     * return permission assignment data between user sets and resource sets (i.e: condition set rules data)
     * @summary Get Data For Set Rule
     * @param {string} orgId Either the unique id of the organization, or the URL-friendly key of the organization (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getDataForUser(orgId: string, projId: string, envId: string, userId: string, options?: any): AxiosPromise<UserData>;
};
/**
...
export declare class OPALDataApi extends BaseAPI {
     ...
     */
    getAllData(requestParameters: OPALDataApiGetAllDataRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FullData>>;
    /**
     *
     * @summary Get Data For Role
     ...
     * @memberof OPALDataApi
     */
    getDataForRole(requestParameters: OPALDataApiGetDataForRoleRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RoleData>>;
    /**
     * return permission assignment data between user sets and resource sets (i.e: condition set rules data)
     * @summary Get Data For Set Rule
     ...
     * @memberof OPALDataApi
     */
    getDataForUser(requestParameters: OPALDataApiGetDataForUserRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UserData>>;
}
