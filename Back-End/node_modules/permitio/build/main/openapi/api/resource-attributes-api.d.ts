 ...
 * @export
 */
export declare const ResourceAttributesApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    deleteResourceAttribute: (projId: string, envId: string, resourceId: string, attributeId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listResourceAttributes: (projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const ResourceAttributesApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Creates a new attribute as part of the resource definition.
     * @summary Create Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    createResourceAttribute(projId: string, envId: string, resourceId: string, resourceAttributeCreate: ResourceAttributeCreate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceAttributeRead>>;
    /**
     * Deletes the attribute and all its related data.  Note: If the attribute is used by policies, removing it will cause the attribute to evaluate as `undefined`.
     * @summary Delete Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteResourceAttribute(projId: string, envId: string, resourceId: string, attributeId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * Gets a single attribute defined on the resource, if such attribute exists.
     * @summary Get Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    getResourceAttribute(projId: string, envId: string, resourceId: string, attributeId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceAttributeRead>>;
    /**
     * Lists all the attributes defined on the resource.
     * @summary List Resource Attributes
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceAttributes(projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<ResourceAttributeRead>>>;
    /**
     * Partially updates the attribute defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    updateResourceAttribute(projId: string, envId: string, resourceId: string, attributeId: string, resourceAttributeUpdate: ResourceAttributeUpdate, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ResourceAttributeRead>>;
};
/**
 * ResourceAttributesApi - factory interface
 * @export
 */
export declare const ResourceAttributesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Creates a new attribute as part of the resource definition.
     * @summary Create Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    deleteResourceAttribute(projId: string, envId: string, resourceId: string, attributeId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<void>;
    /**
     * Gets a single attribute defined on the resource, if such attribute exists.
     * @summary Get Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listResourceAttributes(projId: string, envId: string, resourceId: string, page?: number | undefined, perPage?: number | undefined, options?: any): AxiosPromise<Array<ResourceAttributeRead>>;
    /**
     * Partially updates the attribute defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Attribute
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class ResourceAttributesApi extends BaseAPI {
     ...
     */
    createResourceAttribute(requestParameters: ResourceAttributesApiCreateResourceAttributeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceAttributeRead>>;
    /**
     * Deletes the attribute and all its related data.  Note: If the attribute is used by policies, removing it will cause the attribute to evaluate as `undefined`.
     * @summary Delete Resource Attribute
     ...
     * @memberof ResourceAttributesApi
     */
    deleteResourceAttribute(requestParameters: ResourceAttributesApiDeleteResourceAttributeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Gets a single attribute defined on the resource, if such attribute exists.
     * @summary Get Resource Attribute
     ...
     * @memberof ResourceAttributesApi
     */
    getResourceAttribute(requestParameters: ResourceAttributesApiGetResourceAttributeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceAttributeRead>>;
    /**
     * Lists all the attributes defined on the resource.
     * @summary List Resource Attributes
     ...
     * @memberof ResourceAttributesApi
     */
    listResourceAttributes(requestParameters: ResourceAttributesApiListResourceAttributesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceAttributeRead[]>>;
    /**
     * Partially updates the attribute defined on a resource. Fields that will be provided will be completely overwritten.
     * @summary Update Resource Attribute
     ...
     * @memberof ResourceAttributesApi
     */
    updateResourceAttribute(requestParameters: ResourceAttributesApiUpdateResourceAttributeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ResourceAttributeRead>>;
}
