 ...
 * @export
 */
export declare const InstructionsApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
 ...
 * @export
 */
export declare const InstructionsApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Lists pending organization invites
     * @summary List Language Instructions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
     ...
     * @throws {RequiredError}
     */
    listLanguageInstructions(projId: string, envId: string, options?: AxiosRequestConfig | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<LanguageInstructions>>>;
};
/**
 * InstructionsApi - factory interface
 * @export
 */
export declare const InstructionsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Lists pending organization invites
     * @summary List Language Instructions
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class InstructionsApi extends BaseAPI {
     ...
     */
    listLanguageInstructions(requestParameters: InstructionsApiListLanguageInstructionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<LanguageInstructions[]>>;
}
